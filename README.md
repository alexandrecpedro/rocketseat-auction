...
<div id="theproject">
<h2> 📓 The Project </h2>
<p> Rocketseat Auction platform to create your own auction and share it with friends (web platform and mobile) </p>
</div>

<div id="target">
<h2> 💡 Target </h2>
Development of a Rocketseat Auction system platform to create your own auction and share it with friends (web platform and mobile versions) at NLW (Next Level Week), from Rocketseat
</div>
<br>
...
|        API and backend services (Backend)        |          DOTNET           |        https://nodejs.org/                |
...
|           DotNET ORM (Backend, Database)         |      ENTITY FRAMEWORK     |      https://www.prisma.io/                 |
